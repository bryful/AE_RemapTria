	...
	public partial class TR_Grid
	{
		...
		*/
		...
		public void MakeMenu()
		{
			...
			TR_Menu m_Menu = m_form.Menu;
			m_Menu.ClearMenu();
			m_Menu.AddTopMenu("AE_Remapτρ?α", 93);
			...
			m_Menu.AddSubMenu(1, "SelectionAll");
			m_Menu.AddSubMenu(1, "SelectionToEnd");
		...
		public bool InputEnter()
		{
			...
			if (m_form != null)
			{
				if (m_form.Value >= 0)
				{
					CellData.SetCellNum(m_form.Value);
					m_form.InputClear();
					ret = true;
					ChkSelectionV();
				}
