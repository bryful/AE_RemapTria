namespace AE_RemapTria
{
	partial class T_BListBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnAdd = new AE_RemapTria.TR_Button();
			this.btnDell = new AE_RemapTria.TR_Button();
			this.btnUp = new AE_RemapTria.TR_Button();
			this.btnDown = new AE_RemapTria.TR_Button();
			this.btnEdit = new AE_RemapTria.TR_Button();
			this.SuspendLayout();
			// 
			// BList
			// 
		...
		private TR_Button btnAdd;
		private TR_Button btnDell;
		private TR_Button btnUp;
		private TR_Button btnDown;
		private TR_Button btnEdit;
	}
}
